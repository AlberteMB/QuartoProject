...
- Spring Boot: En las relaciones en @OneToMany, @ManyToOne y @ManyToMany, 
en la base de datos no se guardan los array. 
No los veremos si no usamos otro tipo de de anotación. 

## Semana 9
- Definición de `Imperativa` y `declarativa` en React.
